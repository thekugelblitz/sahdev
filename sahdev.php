        ...
        try {
            ...
            Capsule::schema()->create(
                ...
                function ($table) {
                    ...
                    $table->boolean('client_chat_ds_catalog')->default(1);
                    $table->boolean('client_chat_ds_domain_pricing')->default(1);
                    $table->boolean('client_chat_ds_server_nameservers')->default(1);
                    $table->boolean('client_chat_ds_hosting_addons')->default(1);
                    $table->boolean('client_chat_ds_credit_balance')->default(1);
                    $table->boolean('client_chat_ds_ssl_orders')->default(1);
                    $table->boolean('client_chat_ds_domain_addons')->default(1);
                    $table->boolean('client_chat_ds_config_options')->default(1);
                    $table->boolean('client_chat_ds_quotes')->default(1);
                    $table->boolean('client_chat_ds_announcements')->default(1);
